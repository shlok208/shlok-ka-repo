...
import { Facebook, Instagram, Linkedin, Youtube, Twitter, Building2, Copy, Eye, Calendar, ChevronLeft, ChevronRight, Trash2 } from 'lucide-react'

const PostContentCard = ({ post, isDarkMode, onCopy, onDelete }) => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div className="text-sm leading-tight">
            <div className="font-normal text-sm capitalize">{post.platform || 'Platform'}</div>
      ...
      {post.title && (
        <div className="px-4">
          <h3 className={`text-lg font-normal leading-tight ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
            {post.title}
          </h3>
        </div>
      )}
