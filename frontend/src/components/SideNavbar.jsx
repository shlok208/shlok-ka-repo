...
const navigationItems = [
  ...
  return (
    <div className={`hidden md:block shadow-lg transition-all duration-300 fixed left-0 top-4 h-[calc(100vh-2rem)] z-50 w-48 xl:w-64 flex flex-col overflow-hidden rounded-t-lg ${
