...
const ATSNChatbot = ({ externalConversations = null }) => {
  ...
  useEffect(() => {
    ...
    if (hour < 5) timeGreeting = 'Good late night'
    else if (hour < 12) timeGreeting = 'Good morning'
    else if (hour < 18) timeGreeting = 'Good afternoon'

    // Set the full text to be typed
    setFullGreeting(`${timeGreeting}, ${businessName || 'Traveller'}.`)
  }, [businessName])
  ...
  useEffect(() => {
    ...
    // Generate valid UUID for session ID
  ...
  return (
    <div className="flex flex-col h-full rounded-lg">
      ...
      {showScheduleModal && (
        ...
        >
          <div
            className={`rounded-lg p-6 max-w-md w-full mx-4 ${isDarkMode ? 'bg-gray-800' : 'bg-white'
              }`}
          >
            ...
            <div className="space-y-4">
              <div>
                <label className={`block text-base font-medium mb-1 ${isDarkMode ? 'text-gray-200' : 'text-gray-700'
                  }`}>Date</label>
                <input
                  type="date"
                  ...
                  className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500 ${isDarkMode
            ...
            <div className="flex gap-3 mt-6">
              <button
                ...
                className={`flex-1 px-4 py-2 text-base rounded-md transition-colors ${isDarkMode
              ...
              <button
                ...
                className={`flex-1 px-4 py-2 text-base rounded-md disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 transition-colors ${isDarkMode
      ...
      >
        {messages.length === 0 ? (
          ...
          <div className="flex flex-col items-center justify-center h-full space-y-8">
            {/* Title */}
            <div className={`text-3xl md:text-4xl font-normal ${isDarkMode ? 'text-gray-100' : 'text-gray-900'
              }`}>
              <div className="text-center">
                <span className={`block text-3xl md:text-4xl tracking-tight ${isDarkMode ? 'text-transparent bg-clip-text bg-gradient-to-r from-gray-100 to-gray-400' : 'text-gray-900'}`}>
                  {greetingText}
                  <span className="inline-block w-0.5 h-8 ml-1 align-middle bg-current animate-pulse">|</span>
                </span>
              </div>
            </div>
            ...
            <div className="w-full max-w-lg mx-auto">
              ...
              {saveStatus !== 'saved' && (
                <div className={`flex items-center justify-center gap-2 text-xs mb-4 px-3 py-1 rounded-full ${saveStatus === 'saving'
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full px-6 pr-14 py-4 text-base rounded-[20px] backdrop-blur-sm focus:outline-none shadow-lg ${isDarkMode
              ...
              {/* Instructions */}
              <div className={`mt-6 text-center space-y-4 ${isDarkMode ? 'text-gray-400' : 'text-gray-600'
                }`}>
          ...
          <div className="space-y-6">
            {messages.map((message, index) => (
              ...
              >
                {/* Avatar */}
                <div
                  className={`${message.agent_name?.toLowerCase() === 'emily' || message.agent_name?.toLowerCase() === 'leo' || message.agent_name?.toLowerCase() === 'chase' || message.agent_name?.toLowerCase() === 'atsn ai'
                    ? 'w-16 h-16'
                    : 'w-8 h-8'
                    } rounded-full flex items-center justify-center flex-shrink-0 ${message.sender === 'bot' ? 'hover:scale-110 transition-transform duration-200 cursor-pointer border-2 border-gray-300' : ''
                    } ${message.sender === 'user'
                ...
                <div className={`flex-1 max-w-[60%] ${message.sender === 'user' ? 'text-right' : 'text-left'}`}>
                  <div
                    className={`inline-block p-4 rounded-2xl backdrop-blur-md border shadow-lg ${message.sender === 'user'
                    ...
                    {message.sender === 'bot' ? (
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-between mb-2">
                          <span className={`text-base font-bold bg-clip-text text-transparent ${message.agent_name?.toLowerCase() === 'leo'
                            ? isDarkMode
